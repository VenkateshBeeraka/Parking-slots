...
import com.fission.learn.service.AvailabilityService;
...
public class AvailabilityController {
	...
	public ResponseEntity<String> addAvailabilty(@Validated @PathVariable String buildingNumber,
	...
	public ResponseEntity<String> removeavAvaliab(@PathVariable String buildingNumber,
